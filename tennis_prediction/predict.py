...
model = joblib.load("results/final_tennis_model.pkl")
...
def predict(player1_name, player2_name):
  ...
  match_data = pd.DataFrame([{ #! DO NOT TOUCH
    ...
    "opponent_bpSaved": player2_stats["player_bpSaved"], "opponent_bpFaced": player2_stats["opponent_bpFaced"],
    "player_rank": player1_stats["player_rank"], "player_rank_points": player1_stats["player_rank_points"],
    "opponent_rank": player2_stats["player_rank"], "opponent_rank_points": player2_stats["player_rank_points"],
    ...
    "best_of_3": player1_stats["best_of_3"], "best_of_5": player1_stats["best_of_5"],
    # Add serve totals if you want to compute percentages below
